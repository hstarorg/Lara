...
using Lara.Pay.Tenpay.Params;
using System;

namespace Lara.Pay.Tenpay
{
    public class WechatPayClient
    {
        ...
        public void Unifiedorder(string body, string outTradeNO, int totalFee, string spbillCreateIP, WechatTradeType tradeType, UnifiedorderParams optionalParams = null)
        {
        }
        ...
        public void QueryOrder(string orderNumber, bool isOutTradeNO = false)
        {
        }
        ...
        public void CloseOrder(string outTradeNO, CloseOrderParams optionalParams = null)
        {
        }
        ...
        /// <param name="optionalParams">可选配置参数</param>
        public void QueryRefund(OrderNumberType orderNumberType, string orderNumber, QueryRefundParams optionalParams = null)
        {
        }
        ...
        /// <param name="optionalParams">可选配置参数</param>
        public void DownloadBill(DateTime billDate, WechatBillType billType = WechatBillType.ALL, DownloadBillParams optionalParams = null)
        {
        }
        ...
        /// <param name="optionalParams">可选配置参数</param>
        public void BatchQueryOrderComment(DateTime beginTime, DateTime endTime, int offset = 0, BatchQueryOrderCommentParams optionalParams = null)
        {
        }
        ...
        public void RefundOrder(OrderNumberType orderNumberType, string orderNumber, string outRefundNo, int totalFee, int refundFee, RefundOrderParams optionalParams = null)
        {
        }
        ...
        /// <param name="optionalParams"></param>
        public void DownloadFundFlow(DateTime billDate, WechatAccountType accountType, DownloadFundFlowParams optionalParams = null)
        {
        }
    }
}